...
\begin{itemize}[label={},leftmargin=1.5em]
	...
	\item \hyperref[fig:acp]{Annexe E. Représentation des deux composantes principales issues de l'ACP réalisée sur les 4 variables sélectionnées pour les sujet TSA}
\end{itemize}
%\newpage
